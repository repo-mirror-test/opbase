# aclDestroyBoolArray<a name="ZH-CN_TOPIC_0000001983530448"></a>

## 函数功能<a name="section36583473819"></a>

销毁通过[aclCreateBoolArray](aclCreateBoolArray.md)接口创建的aclBoolArray。
...
<td class="cellrowborder" valign="top" width="46.44%" headers="mcps1.1.4.1.3 "><p id="p96631529192517"><a name="p96631529192517"></a><a name="p96631529192517"></a>需要销毁的aclBoolArray 。</p>
</td>
</tr>
</tbody>
</table>
...
接口调用请参考[aclCreateBoolArray](aclCreateBoolArray.md)的调用示例。
