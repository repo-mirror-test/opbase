# aclGetViewShape<a name="ZH-CN_TOPIC_0000001983690176"></a>

## 函数功能<a name="section36583473819"></a>

获取aclTensor的ViewShape，aclTensor由[aclCreateTensor](aclCreateTensor.md)接口创建。
...
<td class="cellrowborder" valign="top" width="46.44%" headers="mcps1.1.4.1.3 "><p id="li622515318718p0"><a name="li622515318718p0"></a><a name="li622515318718p0"></a>输入的aclTensor。需提前调用<a href="aclCreateTensor.md">aclCreateTensor</a>接口创建aclTensor。</p>
</td>
</tr>
<tr id="row142925372239"><td class="cellrowborder" valign="top" width="29.03%" headers="mcps1.1.4.1.1 "><p id="p42921837142313"><a name="p42921837142313"></a><a name="p42921837142313"></a>viewDims</p>
</td>
...
<td class="cellrowborder" valign="top" width="46.44%" headers="mcps1.1.4.1.3 "><p id="p2029214371238"><a name="p2029214371238"></a><a name="p2029214371238"></a>返回的viewShape的维度值。</p>
</td>
</tr>
<tr id="row2644439162310"><td class="cellrowborder" valign="top" width="29.03%" headers="mcps1.1.4.1.1 "><p id="p26447394235"><a name="p26447394235"></a><a name="p26447394235"></a>viewDimsNum</p>
</td>
<td class="cellrowborder" valign="top" width="24.529999999999998%" headers="mcps1.1.4.1.2 "><p id="p13644139142320"><a name="p13644139142320"></a><a name="p13644139142320"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="46.44%" headers="mcps1.1.4.1.3 "><p id="p4644133952317"><a name="p4644133952317"></a><a name="p4644133952317"></a>返回的viewShape的维度数。</p>
</td>
</tr>
</tbody>
</table>
