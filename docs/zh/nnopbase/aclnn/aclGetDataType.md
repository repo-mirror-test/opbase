# aclGetDataType<a name="ZH-CN_TOPIC_0000001983690180"></a>

## 功能说明<a name="section36583473819"></a>

获取aclTensor的DataType，aclTensor由[aclCreateTensor](aclCreateTensor.md)接口创建。
...
<tr id="row142925372239"><td class="cellrowborder" valign="top" width="29.03%" headers="mcps1.1.4.1.1 "><p id="p42921837142313"><a name="p42921837142313"></a><a name="p42921837142313"></a>dataType</p>
</td>
...
<td class="cellrowborder" valign="top" width="46.44%" headers="mcps1.1.4.1.3 "><p id="li182267310720p0"><a name="li182267310720p0"></a><a name="li182267310720p0"></a>返回的aclTensor的数据类型。</p>
</td>
</tr>
</tbody>
</table>
...
// 获取xTensor的首元素相对于storage的偏移值，offset为0
int64_t offset = 0;
