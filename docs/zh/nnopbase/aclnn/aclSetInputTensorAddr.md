# aclSetInputTensorAddr<a name="ZH-CN_TOPIC_0000001983690196"></a>
...
<td class="cellrowborder" valign="top" width="46.44%" headers="mcps1.1.4.1.3 "><p id="p205854264190"><a name="p205854264190"></a><a name="p205854264190"></a>待刷新的输入aclTensor的索引，取值范围是[0, 所有输入tensor的总数-1]。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="46.44%" headers="mcps1.1.4.1.3 "><p id="p1320933419195"><a name="p1320933419195"></a><a name="p1320933419195"></a>需要刷新到指定aclTensor中记录的Device存储地址。</p>
</td>
</tr>
</tbody>
</table>
...
## 调用示例<a name="section1700943414"></a>
