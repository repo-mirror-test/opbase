...
<td class="cellrowborder" valign="top" width="46.44%" headers="mcps1.1.4.1.3 "><p id="p4942814173110"><a name="p4942814173110"></a><a name="p4942814173110"></a>待刷新的输出aclTensor的索引，取值范围是[0, 所有输出tensor的总数-1]。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="46.44%" headers="mcps1.1.4.1.3 "><p id="p35715819910"><a name="p35715819910"></a><a name="p35715819910"></a>需要刷新到指定aclTensor中记录的Device存储地址。</p>
</td>
</tr>
</tbody>
</table>
...
## 调用示例<a name="section11394144175215"></a>
