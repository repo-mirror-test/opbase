 ...
 * \brief
 */
#ifndef OP_COMMON_OP_HOST_UTIL_BFLOAT16_H
#define OP_COMMON_OP_HOST_UTIL_BFLOAT16_H
...
public:
    ...
    static constexpr Ops::Base::bfloat16 infinity()
    {
        return Ops::Base::bfloat16(0x7F80, Ops::Base::bfloat16::from_bits());
    }
    static constexpr Ops::Base::bfloat16 quiet_NaN()
    {
        return Ops::Base::bfloat16(Ops::Base::bfloat16::NAN_VALUE, Ops::Base::bfloat16::from_bits());
    }
    static constexpr Ops::Base::bfloat16 signaling_NaN()
    {
        return Ops::Base::bfloat16(0x7F80, Ops::Base::bfloat16::from_bits());
    }
    static constexpr Ops::Base::bfloat16 denorm_min()
    {
        return Ops::Base::bfloat16(0x0001, Ops::Base::bfloat16::from_bits());
    }
};
